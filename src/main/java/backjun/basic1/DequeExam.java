        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (s[0]) {
                ...
                case "push_back":
                    ...
                    break;
                case "pop_front":
                    builder.append((deque.size()<=0?-1:deque.pollFirst()) + "\n");
                    break;
                case "pop_back":
                    builder.append((deque.size()<=0?-1:deque.pollLast()) + "\n");
                    break;
                ...
                case "empty":
                    builder.append((deque.isEmpty()?1:0 )+ "\n");
                    break;

                case "front":
                    Integer f = deque.peekFirst();
                    builder.append((f==null?-1:f)+"\n");
                    break;

                case "back":
                    Integer b = deque.peekLast();
                    builder.append((b==null?-1:b)+"\n");
                    break;
            }
        }
